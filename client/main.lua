...
-- Logger/Utils/Keybinds were fetched here but never referenced anywhere in this resource
-- (KEYBINDS below is the component being registered, not consumed) — dead boilerplate, dropped.
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["pulsar_core"]:RegisterComponent("Keybinds", KEYBINDS)
end)
